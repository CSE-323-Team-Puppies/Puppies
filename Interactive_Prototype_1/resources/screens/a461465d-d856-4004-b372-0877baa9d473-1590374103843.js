jQuery("#simulation")
  .on("click", ".s-a461465d-d856-4004-b372-0877baa9d473 .click", function(event, data) {
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-a461465d-d856-4004-b372-0877baa9d473 #s-Label_28 span": {
                      "attributes": {
                        "color": "#80B8F1"
                      }
                    }
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-a461465d-d856-4004-b372-0877baa9d473 #s-Label_29": {
                      "attributes": {
                        "font-size": "12.0pt",
                    ...
                    "#s-a461465d-d856-4004-b372-0877baa9d473 #s-Label_29 .valign": {
                      "attributes": {
                    ...
                    "#s-a461465d-d856-4004-b372-0877baa9d473 #s-Label_29 span": {
                      "attributes": {
                        "color": "#80B8F1",
                        "text-align": "center",
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-a461465d-d856-4004-b372-0877baa9d473 #s-Button span": {
                      "attributes": {
                        "color": "#80B8F1"
                      }
                    }
  ...
  .on("pageload", ".s-a461465d-d856-4004-b372-0877baa9d473 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/0433923f-167c-4dc2-9e17-f65bb57290a2"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
  ...
  .on("variablechange.jim", ".s-a461465d-d856-4004-b372-0877baa9d473 .variablechange", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
